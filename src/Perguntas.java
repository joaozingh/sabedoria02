...
public class Perguntas {
    ...
    private static void cabecalho() {
        ...
        System.out.println("Aluno: João Victor Pereira de Sá ");
        System.out.println("Professor: Brenno Pimenta");
        System.out.println("Boas vindas a todos!!! Esse é um questionário sobre o anime solo leveling.");
        System.out.println("Neste questionário você responderá a 15 questões sobre o solo leveling, sobre o decorrer do tmepo o sung jin-woo foi ficando mais forte e você sabe como??");
        System.out.println();
    }
    }
